                ...
                <div class="row">
                    <div class="subscribe scrollme">
                        <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                            ...
                            <form action="{{route('subscribe')}}" class="subscribe-form" method="get">
                                {{csrf_field()}}
                                <input class="email input-standard-grey input-white" name="subscribe_email" placeholder="Your Email Address" type="email">
                        ...
                        <div class="images-block">
                            ...
                            <img src="{{asset('app/js/animation.velocity.min.js')}}app/img/subscr-mailopen.png" alt="mail" class="mail-2">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- ...end JS Script -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a8fff824bf23924"></script>
</body>
</html>
